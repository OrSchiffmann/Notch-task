  ...
  return (
    <div>
      ...
      <Table
        ...
        rows={[
          ['Business', 'Containment rate', '% of conversations resolved end-to-end without a human. The headline. Target: 70–73% (Bullet\'s figure). To be confirmed at kickoff and calibrated against their intent mix.'],
