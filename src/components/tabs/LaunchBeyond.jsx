  ...
  return (
    <div>
      ...
      <NumberedItem n={4} title="What is the handoff SLA from Glassix to a human agent?">
        The Glassix fallback is the safety net for Phase 1. Is there an agreed SLA on how fast a human agent picks up after AI handoff? Who monitors this metric and who owns it if it degrades?
      </NumberedItem>
      ...
      <NumberedItem n={5} title="Is there a penetration testing or audit requirement before go-live?">
        Some insurers require a third-party pen test or compliance audit before any AI system touches customer data. Does Bullet have this requirement? If yes, who commissions it, how long does it take, and does it block the Phase 1 go-live date?
      </NumberedItem>

      <WarnCard title="Recommended action">
        Send this list to Bullet's Implementation Engineer and their IT/Security lead before the kickoff meeting. Answers to these questions determine whether the Week 7 MVP target is achievable - and several of them have long lead times if escalation is needed.
      </WarnCard>
    </div>
  )
}
